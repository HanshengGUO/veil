...
English | [简体中文](./zh-CN/read-sets.md)
...
The separation lets a reviewer tell whether the declaration, physical source, query, logical rows,
or exact Arrow bytes changed between two runs.
